...
This repository contains a demonstration of the technique.
More specifically, this demo shows RetSpill can perform the following tasks from user space:
...
## Caveats
The exploit in this repo is not reliable (about 50% success rate), thus you might need to rerun the exploit a few times to obtain CFHP.
